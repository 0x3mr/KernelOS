...
// why don't we get seg fault even though we accessed an out of bound memory?
//
// That's undefined behavior, but not necessarily a crash immediately.
// It may still fall in a valid part of the memory[] array,
// so the program continues — silently corrupting memory.